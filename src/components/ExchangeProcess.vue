...
<template>
  ...
  <div class="container">
    ...
    <div class="flex">
      <div class="flex-left"> <img src="@/assets/image/exchange/1.png" alt=""></div>
    ...
    <div class="flex">
      <div class="flex-left"> <img src="@/assets/image/exchange/2.png" alt=""></div>
      <div class="flex-right">
        <h3>支付定金</h3>
    ...
    <div class="flex">
      <div class="flex-left"> <img src="@/assets/image/exchange/4.png" alt=""></div>
      <div class="flex-right">
        <h3>提交相关资料</h3>
...
.container {
  ...
  .content {
    ...
    padding: 20px 0;
    border-radius: var(--border-radius);
    background-image: linear-gradient(135deg, #fbfcff, #f5f8ff);
    ...
    .left {
      ...
      span {
        ...
        &::after {
          ...
          width: 0;
          height: 0;
          border-color: transparent transparent transparent #3e79f9;
          border-style: solid;
